...
class GoogleLyriaProvider:
    ...
    async def generate(
        ...
        *,
        ...
        # Combine audio chunks into raw 16-bit PCM stream
        ...
        # Lyria returns raw 16-bit PCM audio (48kHz, stereo). Wrap it in a proper
        # WAV container so standard media players can read and play it.
